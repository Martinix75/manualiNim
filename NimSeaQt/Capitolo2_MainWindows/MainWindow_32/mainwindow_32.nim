...
import seaqt/[qapplication, qmainwindow, qpushbutton, qlineedit, qwidget, qboxlayout, qicon, qmenubar, qaction, qmenu]
import qtconnect
...
proc finestra() =
  ...
  form.menu_f.addAction(form.azione1) #nel menu _f ora iserisco un azione (vose del menu).
  discard form.menu_f.addSeparator() #inserisco un separatore nem menu_f
  form.menu_f.addAction(form.azione2)#nel menu _f ora iserisco un azione (vose del menu).
  
  form.menu_c = QMenu.create("Configura")
  discard form.menu_x.addMenu(form.menu_c)  #inserisco il menu_c nella barra dei menu.
  form.menu_c.addAction(form.azione3)
  form.sottoMenu = QMenu.create("Seriale") #creo un sotto menu  a menu_c.
  discard form.menu_c.addMenu(form.sottoMenu) #lo inserisco nel manu_c.
  form.sottoMenu.addAction(form.azione5)#lo popolo.
  
  form.menu_a = QMenu.create("Aiuto")
  discard form.menu_x.addMenu(form.menu_a)  #inserisco il menu_a nella barra dei menu.
  form.menu_a.addAction(form.azione4)
  
  form.mwin.setCentralWidget(form.qwi_1) #setto il widget centrale con il Qwidget personale.
  form.mwin.setWindowTitle("MainWindow Menu")
