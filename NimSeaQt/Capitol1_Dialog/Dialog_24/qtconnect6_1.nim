...
macro connect*(widgetCall: typed; widgetSignal: untyped; callFunction: untyped) =
...
macro connect*[T](widgetCall: typed; widgetSignal: untyped; callFunction: untyped; functionArg: T) =
  let signalParameterTypes = getSignalParameterTypes()
  let signalStr = $widgetSignal
